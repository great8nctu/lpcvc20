...
def kcnet():
    ...
    w = Hswish().call(w)
    w = tf.keras.layers.AveragePooling2D((5, 5))(w)
    ...
    w = tf.keras.layers.Conv2D(1000, 1, 1, use_bias=True, padding="same", kernel_initializer=he_normal_fan_out)(w)
